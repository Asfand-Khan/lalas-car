  ...
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-green-50 ring-1 ring-inset ring-green-600/20 text-green-700 hover:bg-green-50",
        danger: "border-transparent bg-red-50 ring-1 ring-inset ring-red-600/20 text-red-700 hover:bg-red-50"
      },
    },
    defaultVariants: {
      variant: "default",
